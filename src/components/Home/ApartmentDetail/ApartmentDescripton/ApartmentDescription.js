    ...
    return (
        <>
            <div className='container'>
                    ...
                    <div className='col-md-8 col-sm-12'>
                        <div className='mt-4'>
                            <div className='d-flex font-weight-bold justify-content-between'>
                                <h1 style={{ color: '#16322E!important' }}>
                                    Name
                                </h1>
                                <h1 style={{ color: '#16322E!important' }}>
                                    $254
                ...
                <p>
                    3000 sq-ft., 3 Bedroom, Semi-furnished, Luxurious, South
                    facing Apartment for Rent in Rangs Malancha, Melbourne.
                </p>
            </div>
            <div className='mt-5'>
            ...
            <div className='mt-5 mb-5'>
                ...
                <ul className='list-unstyled'>
                    <li>
                        Address & Area : Rangs Malancha, House-68, Road-6A (Dead
                        End Road), Dhanmondi Residential Area.
                    </li>
                    <li>Flat Size : 3000 Sq Feet.</li>
                    <li>
                        Floor : A5 (5th Floor) (6 storied Building ) (South
                        Facing Unit)
                    </li>
                    <li>
                        Room Category : 3 Large Bed Rooms with 3 Verandas,
                    ...
                    <li>
                        Additional Facilities : a. Electricity with full
                        generator load, b. Central Gas Geyser, c. 2 Car Parking
                        with 1 Driver’s Accommodation, d. Community Conference
                        Hall, e. Roof Top Beautified Garden and Grassy Ground,
                        f. Cloth Hanging facility with CC camera
                    </li>
                </ul>
            </div>
        </>
